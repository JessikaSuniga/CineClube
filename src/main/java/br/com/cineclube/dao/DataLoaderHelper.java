...
public class DataLoaderHelper {
	...
	public static void loadData(
		...
		multiplasCategorias.add(daoc.findByNome("Action"));
		multiplasCategorias.add(daoc.findByNome("Sci-fi"));
		multiplasCategorias.add(daoc.findByNome("Drama"));
		
		List<Filme> filmeList = new ArrayList<>();
		filmeList.add(new Filme("Fragmentado", 					9f, 	LocalDate.of(2017, 3, 17), multiplasCategorias));
		filmeList.add(new Filme("Matrix", 						9f, 	LocalDate.of(1999, 5, 21), daoc.findByNome("Ficcao cientifica")));
		filmeList.add(new Filme("Gente Grande",					8f, 	LocalDate.of(2010, 9, 24), daoc.findByNome("Ficcao cientifica")));
		filmeList.add(new Filme("Resgate", 						10f, 	LocalDate.of(2020, 4, 24), daoc.findByNome("Ficcao cientifica")));
		filmeList.add(new Filme("Lupin", 						9f, 	LocalDate.of(2021, 1, 8), daoc.findByNome("Ficcao cientifica")));
		filmeList.add(new Filme("The Sinner", 					8f, 	LocalDate.of(2017, 1, 1), daoc.findByNome("Ficcao cientifica")));
		filmeList.add(new Filme("Chernobyl", 					8.4f, 	LocalDate.of(2012, 7, 13), daoc.findByNome("Ficcao cientifica")));
		filmeList.add(new Filme("Por tras de seus olhos",		8.2f, 	LocalDate.of(2021, 2, 17), daoc.findByNome("Ficcao cientifica")));
		filmeList.add(new Filme("Vozes e vultos", 				7.6f, 	LocalDate.of(2021, 4, 21), daoc.findByNome("Ficcao cientifica")));
		filmeList.add(new Filme("O Inocente", 					9f, 	LocalDate.of(2020, 4, 21), daoc.findByNome("Ficcao cientifica")));
		filmeList.add(new Filme("Stranger Things", 				6.5f, 	LocalDate.of(2016, 7, 15), daoc.findByNome("Ficcao cientifica")));
		filmeList.add(new Filme("Hacher", 						10f, 	LocalDate.of(2015, 3, 5), daoc.findByNome("Ficcao cientifica")));		
		filmeList.add(new Filme("Unidade 42", 					9.40f, 	LocalDate.of(2017, 10, 21), daoc.findByNome("Ficcao cientifica")));
		filmeList.add(new Filme("Um contratempo",				8.11f, 	LocalDate.of(2017, 1, 6), daoc.findByNome("Ficcao cientifica")));
		filmeList.add(new Filme("Terror na estrada", 			10f, 	LocalDate.of(2015, 10, 6), daoc.findByNome("Ficcao cientifica")));
		filmeList.add(new Filme("Pressagio", 					9.3f, 	LocalDate.of(2009, 3, 20), daoc.findByNome("Ficcao cientifica")));
		filmeList.add(new Filme("Labirinto verde", 				6.5f, 	LocalDate.of(2017, 4, 10), daoc.findByNome("Ficcao cientifica")));
		filmeList.add(new Filme("Deadwind", 					10f, 	LocalDate.of(2018, 1, 15), daoc.findByNome("Ficcao cientifica")));
		...
		categoriaFragmentado.add(daoc.findById(1L).get());
		categoriaFragmentado.add(daoc.findById(2L).get());
		Filme fragmentado = daof.findById(1L).get();
		fragmentado.setPessoas(elencoFragmentado);
		fragmentado.setCategorias(categoriaFragmentado);
